...
export default class Camera extends Component {
  constructor(props) {
    ...
    this.requestCameraRollPermission = this.requestCameraRollPermission.bind(
      this
    );
        ...
        >
          <View style={styles.header}>
            <View style={styles.topWrapper}>
              <TouchableOpacity
                style={styles.touchableOpacityMenuIcon}
          ...
          <View style={styles.footer}>
            <TouchableOpacity
              ...
              onPress={console.log("going to library")}
            >
              <Icon name="collections" style={styles.icon} />
            </TouchableOpacity>
